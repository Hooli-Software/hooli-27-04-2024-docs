...
<a name="project"><h1> Структура проекта </h1></a>
## Фронт-енд

Сдержание:
- [[#Страница поиска препаратов]]
- [[#Страница входа]]
...
- [[#Боковая панель]]
- [[#Верхняя панель]]
- [[#Таблица "Соответствуют критериям"]]
- [[#Таблица "Ближайшие подходящие продукты"]]
...
Содержит:
- **Статичный** заголовок
- [[#Модель препарата|Таблицу с препаратами]]
